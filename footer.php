...
<footer class="footer padding-50">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="social-icons pt-4">
                    ...
                    <a href="https://www.facebook.com/merakhataofficial/"><i class="fa fa-facebook"
                            style="font-size: 26px;"></i></a>

                    <a href="https://www.linkedin.com/company/merakhata/"><i class="fa fa-linkedin"
                            style="font-size: 26px;"></i></a>
    ...
    <a href="https://www.merakhata.com/income-tax-return-filing-online.php#check-itr-price" class="floating-btn"
        aria-label="Check ITR Price">
...
<div id="whatsapp" class="text-white">
    ...
    <a href="https://api.whatsapp.com/send?phone=919030815060&text=Hello+Team+Merakhata%2C+I+would+like+to+enquire+about+your+services.&oq=Hello+Team+Merakhata%2C+I+would+like+to+enquire+about+your+services"
