...
class DemoTicketsSeeder extends Seeder
{
    ...
    {
        $subjects = json_decode($this->fs->get(database_path('seeders/demo/demo-ticket-subjects.json')), true);
    ...
    {
        $demoCategories = json_decode($this->fs->get(database_path('seeders/demo/demo-categories.json')), true);
    ...
    {
        $bodies = json_decode($this->fs->get(database_path('seeders/demo/demo-reply-bodies.json')), true);
