...
return [
        ...
        'value' => json_encode([
            [
                ...
                'items' => [
                    [
                        ...
                        'label' => 'Tickets',
                        'action' => 'mailbox',
                        'condition' => 'permission:tickets.update',
                    ],
                    [
                        'type' => 'route',
                        'order' => 2,
                        ...
                        'condition' => 'permission:articles.create',
                    ],
                    [
                        'type' => 'route',
                        'order' => 2,
            ...
            [
                ...
                'items' => [
                    [
                        'type' => 'route',
                        'condition' => ['auth', '!permission:tickets.update'],
                        'label' => 'My Tickets',
    ...
    [
        'name' => 'mail.webhook_secret_key',
        'value' => Illuminate\Support\Str::random(30),
        'private' => 1,
    ],
    ...
    [
        ...
        'value' => json_encode([
            ...
            'descriptionLabel' =>
                'Tell us more...Please be as detailed as possible.',
